    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input class="wc-input" type="text" id="title" placeholder="Enter service name" name="title" required>
            </div>
            <div class="wc-form-row" >
                <div class="form-group">
                    <label for="email">Pricing:</label>
                    <input class="wc-input" type="text" id="title" placeholder="$100" name="pricing" required>
                </div>
                <div class="form-group">
                    <label >Status:</label>
            ...
            <div class="form-group">
              ...
              <input class="wc-input" type="text" id="shortDesc" placeholder="Short Description" name="shortDesc" maxlength="200" required>
            </div>
              <div class="form-group">
